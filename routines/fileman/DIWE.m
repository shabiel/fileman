DIWE ;SFISC/GFT,XAK-START OF WP ;30MAR2013
 ;;22.0;VA FileMan;**8,18,999,1009,1021,1044,1045**;Mar 30, 1999
...
W W !?DL+DL-2
 S Z=+$P($G(DC),U,2),Z=$S(Z:$P($G(^DD(Z,.01,0)),U,2),1:"") I Z["I",DWLC W !,$$EZBLD^DIALOG(3090,DH) W ! S I=DWLC,J=1 D LL^DIWE1 G Q ;UNEDITABLE W-P
