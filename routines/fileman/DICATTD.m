DICATTD	;SFISC/GFT-SCREEN-MODE 'MODIFY FILE ATTRIBUTES' ;9NOV2012
...
SCREEN	;
	...
	S N=$$TYPE I N="" S:DUZ(0)'="@" DIR("S")="I Y-9,Y<10!$O(^(201,0))" Q
	I N=6 S DIR("S")="I Y=6" Q  ;can't change a COMPUTED FIELD's type
	S DIR("S")="I Y-6,Y-9,Y-99,Y<10!$O(^(201,0))"_$P(",Y-5",U,N\2-2!'$D(^DD(DICATTA,0,"UP"))!(DICATTF-.01)!($O(^DD(DICATTA,DICATTF))>0))_$S(N=7:",Y-8",N=8:",Y-7",1:"")
	Q
	;
BRANCH	;given X=TYPE
