DINIT3	;SFISC/GFT-INITIALIZE VA FILEMAN ;9NOV2012
...
DIK	F I=.2,.4,.5,.6,.7,.601,.602,.401,.4001,.4011,.4012,.402,.4021,.4011624,.41,.411,.21,1,1.005,1.01,1.1,1.11,1.113,1.1132,1.12,1.13,1.1321,1.14,.403,.4031,.403115,.40315,.4032,.404,.40415,.4044,1.2,1.207 D XX
	F I=.44,.441,.4411,.447,.448,.42,.81,.81101,.81201,.8121,.87,.4014,.40141,.401418,.401419,.83,.404421 D XX
	...
	F DIK="^DIC(.2,","^DIPT(","^DIST(1.2,","^DIST(.44,","^DI(.81,","^DI(.87,","^DIST(.403,","^DIST(.404,","^DIST(.46,","^DI(.85,","^DD(""IX"",","^DD(""KEY""," D X
